...
const LeftArrowSvg = ({ size }) => {
  return (
    <svg
      aria-label="Chevron icon to see all follow requests"
      className="fill-white rotate-[270deg]"
      height={size ?? "24"}
      role="img"
      viewBox="0 0 24 24"
      width={size ?? "24"}
  ...
  return (
    ...
    >
      ...
      >
        <g
          className="fill-white"
          id="ic_fluent_sticker_24_regular"
          fill-rule="nonzero"
        >
          <path
    ...
    >
      <g className="">
        <g>
          <path
            className="fill-white"
            d="M244.271,173.982l-37.72-20.689c-16.282-8.907-37.549-30.203-46.447-46.471l-20.636-37.744
      ...
      <g>
        <g>
          <path
            className="fill-white"
            d="M493.527,109.245l-37.72-20.631c-16.282-8.907-37.549-30.174-46.447-46.443L388.723,4.442
      ...
      <g>
        <g>
          <path
            className="fill-white"
            d="M438.136,386.196l-37.72-20.631c-16.282-8.907-37.549-30.174-46.447-46.443l-20.636-37.729
			c-3.227-5.923-12.964-5.923-16.191,0l-20.645,37.734c-8.889,16.268-30.156,37.535-46.429,46.438l-37.729,20.631
			c-2.966,1.618-4.805,4.724-4.805,8.1c0,3.376,1.839,6.482,4.805,8.1l37.729,20.636c16.264,8.894,37.531,30.161,46.438,46.438
