const PostWallLoader = () => {
  return (
    <div className="grid grid-cols-3 grid-rows-2 gap-1 md:gap-4 mb-1 md:mb-4 animate-pulse">
...
export { PostWallLoader, PostWallLoader2, PostWallLoader3 };
